...
public class JogoDaVelha extends JFrame{
    ...
    public JogoDaVelha(){
        ...
        po.setBounds(450,75,150,30);
        e.setBounds(500,75,200,30);
        
        zerar.setBounds(400,250,100,30);
        ...
        bt[9].addActionListener(new java.awt.event.ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if(click [9] == false){
                    click[9] = true;
